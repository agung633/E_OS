...
<a href="calonosis/buat.php" class="btn btn-success"><i class="fa fa-file"></i>
                              Export File
                              </a>
<a href="?page=calonosis&action=hapus" class="btn btn-danger">
                              Hapus
                              </a>
   ...
   <div class="col-md-10 col-sm-12">
      <table class="table table-striped table-hover">
            <thead>
                  ...
                  <th width="200px" style="text-align:center;">Nilai</th>
            ...
            <tbody>
                  ...
                  $sql = mysqli_query($con, "SELECT * FROM t_calon LIMIT $start,5");
      ...
      ?>
            <li class="waves-effect">
               <a href="?page=calonosis&hlm=<?php  echo $hlmn; ?>">
      ...
      ?>
            <li <?php if ($hlm != $i) { echo 'class="waves-effect"'; } else { echo 'class="active"'; } ?>>
               <a href="?page=calonosis&hlm=<?php  echo $i; ?>">
                  <?php  echo $i; ?>
               </a>
            </li>
         <?php
         ...
         ?>
            <li class="waves-effect">
               <a href="?page=calonosis&hlm=<?php  echo $next; ?>">

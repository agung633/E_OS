    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="?page=agenda"><i class="fa fa-circle-o"></i> Agenda</a></li>
              </ul>
            </li>
            <li>
     ...
     <div class="content-wrapper">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2023 .</strong> All rights reserved. Powered by : <strong>Admin Lte</strong>
      </footer>
